define(
    ...
    function(angularAMD) {
        ...
        angularAMD.controller("role_permissionList_Ctrl",function( $scope,model,amHttp,$modalInstance,gridDefaultOptionsService,transervice,uiGridConstants,httpService ){
