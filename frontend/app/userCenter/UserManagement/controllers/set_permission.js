...
define(
    ...
    function (angularAMD) {
                ...
                this.showDialog = function (model) {
                    return $modal
                        .open({
                            ...
                            templateUrl: 'app/userCenter/userManagement/views/set_permission.html?ver=' + _version_,
                            resolve: {
                                model: function () {
                                    return model;
                                }
        ...
        angularAMD.controller("set_permission_Ctrl", function ($scope, model, amHttp, $modalInstance, configService,transervice, role_list_service,messageService,Notification, uiGridConstants, gridDefaultOptionsService, httpService, userChooseService, roleChooseService, systemChooseService) {
            //所有权限组信息
            ...
            $scope.gridPermissionsOptions = {
                columnDefs: [
                    ...
                    {field: 'PERMISSIONR_REMARKS', displayName: transervice.tran('权限说明'), enableCellEdit: false},
                    {
                        ...
                        cellTemplate:
                        '<input type="checkbox" class="ui-grid-cell-contents ng-binding ng-scope" ng-model="stateFlag"  ng-if="row.entity.STATE==1" ng-checked=true></input>' +
                        '<input type="checkbox" class="ui-grid-cell-contents ng-binding ng-scope" ng-model="stateFlag"  ng-if="row.entity.STATE==0" ng-checked=false></input>'
                    }
                ],
                enablePagination: false, //是否分页，默认为true
                enablePaginationControls: false, //使用默认的底部分页
            ...
            $scope.cancel = function () {
                $modalInstance.close($scope);//返回数据
