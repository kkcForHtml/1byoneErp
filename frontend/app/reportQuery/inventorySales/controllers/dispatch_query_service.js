...
define(
    ...
    function (angularAMD) {
            ...
            function ($q, $modal) {
                this.showDialog = function (model) {
                    return $modal
                        .open({
                            animation: true,
                            controller: "dispatchQueryCtrl",
                            backdrop: "static",
                            size: "85%",//lg,sm,md,llg,ssm
                            templateUrl: 'app/reportQuery/inventorySales/views/dispatch_query.html?ver=' + _version_,
                            resolve: {
                                model: function () {
                                    return model;
                                }
        ...
        angularAMD.controller("dispatchQueryCtrl", function ($scope, amHttp, $modalInstance, model, transervice,configService, uiGridConstants, commonService, httpService, gridDefaultOptionsService) {
            $scope.gridOptions = {
                columnDefs: [
                    {
                        field: 'PLAN_AT',
                    ...
                    { field: 'ORGANISATION_NAME_CN',width: 100, displayName: transervice.tran('国家') },
                    ...
                    {field: 'COMMI_PERIOD',width: 100, displayName: '交货日期', enableCellEdit: false},
            ...
            function getOrgList() {
                ...
                return configService.getOrganisationList([4]).then(function (datas) {
                    ...
                    $scope.orgList.push({
                        "ORGANISATION_ID": "",
                        "o_organisation": {"ORGANISATION_NAME_CN": "请选择"}
                    });
            ...
            getOrgList().then(function(){
                ...
                if (model) {
                    ...
                    $scope.selectWhere = {};
                    $scope.searchCNumber = $scope.model.searchCNumber;
                    $scope.selectWhere.isInit = $scope.model.isInit;
                    $scope.selectWhere.searchCNumber = $scope.model.searchCNumber;
                }
                $scope.init();
            });
