define(
    ...
    function (angularAMD) {
            ...
            function ($q, $modal) {
                this.showDialog = function (model) {
                    return $modal
                        .open({
                            animation: true,
                            controller: "money_add_Ctrl",
                            backdrop: "static",
                            size: "llg",//lg,sm,md,llg,ssm
                            templateUrl: 'app/masterCenter/money/views/money_add.html?ver=' + _version_,
                            resolve: {
                                model: function () {
                                    return model;
                                }
        ...
        angularAMD.controller("money_add_Ctrl", function ($scope, $confirm, $filter, $timeout, amHttp, uiGridConstants, httpService, model, $modalInstance, Notification, transervice, $http, $q, $interval, commonService, gridDefaultOptionsService, messageService) {
            ...
            $scope.save = function () {
                ...
                return httpService.httpHelper(httpService.webApi.api, "master/basics/money", "create", "POST", moodelTemp).then(function (datas) {
