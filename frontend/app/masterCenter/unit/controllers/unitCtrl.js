        ...
        function ($scope, $confirm, Notification, httpService,amHttp, transervice, $filter,uiGridConstants,commonService,gridDefaultOptionsService,$q) {
            ...
            $scope.init=function () {
                ...
                var   datam={
                    ...
                    'orderby':'UNIT_STATE desc,UPDATED_AT desc'
                };
            ...
            $scope.del=function(){
                ...
                return $confirm({ text: transervice.tran('是否确认删除') })
                    .then(function () {
                        ...
                        rows.forEach((obj)=>{
                            !obj.UNIT_ID?addArray.push(obj):myArray.push(obj);
                        })
                        ...
                        if(myArray.length > 0 ){
                            ...
                            httpService.httpHelper(httpService.webApi.api, "master/basics/unit", "delete", "POST", deleteRowModel).then(
                                function (datas) {
