    ...
    function numeric($locale) {
        ...
        function link(scope, el, attrs, ngModelCtrl) {
            ...
            function round(value) {
                ...
                return (Math.round(value * d) / d).toFixed(decimals)+'';
            }
            ...
            function parseViewValue(value) {
                ...
                if (empty) {
                    ...
                    if (regex.test(value) && (value.length <= maxInputLength)) {
                        ...
                        if(lastValidValue==undefined){
                            lastValidValue=scope[attrs.ngModel];
                            if(lastValidValue==undefined){
                                lastValidValue=value.replace(/[^0-9]/g,'');
                            }
                        }
                        ngModelCtrl.$setViewValue(formatViewValue(lastValidValue));
                        ngModelCtrl.$render();
            ...
            function onBlur() {
                ...
                if (!angular.isUndefined(value)) {
                    ...
                    ngModelCtrl.$viewValue = formatPrecision(value).toString();
                    ngModelCtrl.$render();
                }
            }
