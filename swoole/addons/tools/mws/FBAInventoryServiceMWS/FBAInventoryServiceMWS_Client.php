...
namespace addons\tools\mws\FBAInventoryServiceMWS;
...
use  addons\tools\mws\FBAInventoryServiceMWS\FBAInventoryServiceMWS_Interface;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\ListInventorySupplyRequest;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\ListInventorySupplyResponse;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\ResponseHeaderMetadata;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\GetServiceStatusRequest;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\GetServiceStatusResponse;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\ListInventorySupplyByNextTokenRequest;
use  addons\tools\mws\FBAInventoryServiceMWS\Model\ListInventorySupplyByNextTokenResponse;
use  addons\tools\mws\FBAInventoryServiceMWS\FBAInventoryServiceMWS_Exception;
...
class FBAInventoryServiceMWS_Client implements FBAInventoryServiceMWS_Interface
{
    ...
    private function _invoke(array $parameters)
    {
        try {
            ...
            for (;;) {
                ...
                if ($status == 200) {
                    return array('Status'=>$status,'ResponseBody' => $response['ResponseBody'],
    ...
    */
    private function _extractResponseHeaderMetadata($rawHeaders){
        ...
        $result =  new ResponseHeaderMetadata(
     ...
     * execute request
     * @param array $param
     * @return \addons\tools\mws\ExceptionLogs|array
     */
    public function requestExe(array $param)
    {
        $retries = 0;
        for (;;) {
            $httpResponse = $this->_invoke($param);
            ...
            die(new ExceptionLogs(array ('ErrorCode' => '4006',
                'Message' => json_encode($httpResponse['Body']))) );
        }
    }
