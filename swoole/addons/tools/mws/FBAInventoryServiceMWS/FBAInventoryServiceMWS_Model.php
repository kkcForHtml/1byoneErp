...
use addons\tools\mws\FBAInventoryServiceMWS\Model\FBAInventoryServiceMWS_Model_ListInventorySupplyResult;
            ...
            if (is_array($fieldType)) {
                if ($fieldType[0] == "object") {
                    ...
                    if ($elements->length >= 1) {
                        //require_once (dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php");
                            ...
                            $this->_fields[$fieldName]['FieldValue'][] = new ListInventorySupplyRequest($element);
                        }
                    } 
                } else {
                    if (isset($field['ListMemberName'])) {
                ...
                if ($this->_isComplexType($fieldType)) {
                    ...
                    if ($elements->length == 1) {
                        ...
                        $this->_fields[$fieldName]['FieldValue'] = new FBAInventoryServiceMWS_Model_ListInventorySupplyResult($elements->item(0));
                    }   
                } else {
                    if($fieldType[0] == "@") {
