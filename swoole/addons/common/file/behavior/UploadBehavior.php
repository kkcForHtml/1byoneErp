...
namespace addons\common\file\behavior;
...
class UploadBehavior extends \yii\base\Behavior
{
    ...
    public function __get($name)
    {
        if ($name === $this->attribute) {
            if ($this->_file === null) {
                $this->_file = PHP_SAPI === 'cli' && extension_loaded('swoole') ? \yii\swoole\web\UploadedFile::getInstance(new FileModel(), $this->attribute) : UploadedFile::getInstance(new FileModel(), $this->attribute);
            }
            return $this->_file;
        } else {
