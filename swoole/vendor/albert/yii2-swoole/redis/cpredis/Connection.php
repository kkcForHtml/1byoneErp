...
class Connection extends \yii\base\Component
{
    ...
    {
        $this->connection = Yii::createObject($this->redisClass);
        $this->connection->connect($this->hostname, $this->port, $this->timeout);
    ...
    public function __call($name, $params)
    {
        ...
        if (in_array($redisCommand, $this->redisCommands)) {
            $response = $this->executeCommand($name, $params);
    ...
    {
        return $GLOBALS['call_user_func_array']([$this->connection, $name], $params);
    }
