...
class AccessRule extends Component
{
    ...
    protected function matchRole($user)
    {
        ...
        foreach ($this->roles as $role) {
            if ($role === '?') {
                ...
                if (!isset($roleParams)) {
                    $roleParams = $this->roleParams instanceof Closure ? $GLOBALS['call_user_func']($this->roleParams, $this) : $this->roleParams;
                }
    ...
    {
        return empty($this->matchCallback) || $GLOBALS['call_user_func']($this->matchCallback, $this, $action);
    }
}
