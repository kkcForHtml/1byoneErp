...
class Container extends Component
{
    ...
    public function get($class, $params = [], $config = [])
    {
        ...
        if (is_callable($definition, true)) {
            ...
            $object = $GLOBALS['call_user_func']($definition, $this, $params, $config);
    ...
    public function invoke(callable $callback, $params = [])
    {
        if (is_callable($callback)) {
            return $GLOBALS['call_user_func_array']($callback, $this->resolveCallableDependencies($callback, $params));
        } else {
            return $GLOBALS['call_user_func_array']($callback, $params);
        }
    }
