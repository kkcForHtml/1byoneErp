...
abstract class Cache extends Component implements \ArrayAccess
{
    ...
    public function get($key)
    {
        ...
        if ($value === false || $this->serializer === false) {
            ...
            $value = $GLOBALS['call_user_func']($this->serializer[1], $value);
        }
            ...
            if (isset($values[$newKey])) {
                if ($this->serializer === false) {
                    ...
                    $value = $this->serializer === null ? unserialize($values[$newKey])
                        : $GLOBALS['call_user_func']($this->serializer[1], $values[$newKey]);
    ...
    public function set($key, $value, $duration = null, $dependency = null)
    {
        ...
        if ($this->serializer === null) {
            ...
            $value = $GLOBALS['call_user_func']($this->serializer[0], [$value, $dependency]);
        }
        $key = $this->buildKey($key);
    ...
    public function getOrSet($key, $callable, $duration = null, $dependency = null)
    {
        ...
        $value = $GLOBALS['call_user_func']($callable, $this);
